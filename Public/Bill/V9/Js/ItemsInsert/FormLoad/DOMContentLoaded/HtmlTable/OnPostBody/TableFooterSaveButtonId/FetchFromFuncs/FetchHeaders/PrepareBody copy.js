...
let jFLocalTableFooterPartyNameInputId = () => {
  ...
  let jVarLocalHtmlId = document.getElementById(
    jVarLocalTableFooterPartyNameInputId,
  );
...
let jFLocalTableFooterVoucherTypeInputId = () => {
  ...
  let jVarLocalHtmlId = document.getElementById(
    jVarLocalTableFooterVoucherTypeInputId,
  );
...
let jFLocalTableFooterDateInputId = () => {
  ...
  let jVarLocalHtmlId = document.getElementById(
    jVarLocalTableFooterDateInputId,
  );
...
let jFLocalTableFooterReferenceInputId = () => {
  ...
  let jVarLocalHtmlId = document.getElementById(
    jVarLocalTableFooterReferenceInputId,
  );
...
let jFLocalTableFooterVoucherCancelledInputId = () => {
  let jVarLocalTableFooterVoucherCancelledInputId =
    "TableFooterVoucherCancelledInputId";
  let jVarLocalHtmlId = document.getElementById(
    jVarLocalTableFooterVoucherCancelledInputId,
  );

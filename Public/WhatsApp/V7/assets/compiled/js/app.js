        ...
        "./src/replace.js": function (s, f, r) {
          ...
          function E(_) {
            var v =
              ...
              O = A(_),
              T = O["data-feather"];
            if ((delete O["data-feather"], h.default[T] === void 0)) {
              console.warn("feather: '" + T + "' is not a valid icon");
              return;
            }
    ...
    (function (s, f) {
      ...
      const x = {
        ...
        trigger(n, e, t) {
          ...
          const w = on(new Event(e, { bubbles: y, cancelable: !0 }), t);
          return (
            M && w.preventDefault(),
            b && n.dispatchEvent(w),
      ...
      function xi(n) {
        var e,
          ...
          B = d.y,
          R = B === void 0 ? 0 : B,
          z = typeof w == "function" ? w({ x: N, y: R }) : { x: N, y: R };
        ((N = z.x), (R = z.y));
        ...
        var ee = Object.assign({ position: y }, M && Xo),
          ye = w === !0 ? Qo({ x: N, y: R }, se(t)) : { x: N, y: R };
        if (((N = ye.x), (R = ye.y), b)) {
          var ie;
                ...
                if (!P) {
                  ...
                  if (Ni(X, Q)) {
                    ...
                    for (var V = 0; V < w.orderedModifiers.length; V++) {
                      ...
                      typeof K == "function" &&
                        (w =
                          K({ state: w, options: q, name: J, instance: N }) ||
                          w);
                    }
                  }
                }
          ...
          function B() {
            w.orderedModifiers.forEach(function (z) {
              ...
              if (typeof V == "function") {
                var F = V({ state: w, name: Y, instance: N, options: Q }),
                  K = function () {};
                I.push(F || K);
              }
            });
